...
- `ANTIVIRUS_PAM_POLICY_INTEGRITY_REQUIRED`
- `ANTIVIRUS_PAM_TERMINATION_ESCALATION`
- `ANTIVIRUS_TELEMETRY_QUEUE_MAX_RECORDS`
- `ANTIVIRUS_ENFORCE_DESTINATION_REPUTATION`
- `ANTIVIRUS_DESTINATION_REPUTATION_BLOCK_THRESHOLD`
